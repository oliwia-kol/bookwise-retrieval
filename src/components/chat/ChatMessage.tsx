              ...
              <div className="prose prose-sm prose-invert max-w-none text-sm leading-relaxed">
                <ReactMarkdown
                  components={{
                    ...
                    code: ({ children }) => (
                      <code className="px-1.5 py-0.5 rounded bg-secondary text-primary text-xs font-mono">
                        {children}
                      </code>
                    ),
                    pre: ({ children }) => (
                      <pre className="p-3 rounded-lg bg-secondary overflow-x-auto mb-3">
                        {children}
                      </pre>
                    ),
                    ...
                    blockquote: ({ children }) => (
                      <blockquote className="border-l-2 border-primary pl-3 my-3 italic text-foreground/80">
                        {children}
                      </blockquote>
                    ),
                  }}
